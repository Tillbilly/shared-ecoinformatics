 ...
 * generated in the au.edu.aekos.shared.doiclient.jaxb package. 
...
public class ObjectFactory {
    ...
    private final static QName _ResourceDescriptionsDescriptionBr_QNAME = new QName("http://datacite.org/schema/kernel-2.1", "br");
    private final static QName _ResourceContributorsContributorContributorName_QNAME = new QName("http://datacite.org/schema/kernel-2.1", "contributorName");
    private final static QName _ResourceContributorsContributorNameIdentifier_QNAME = new QName("http://datacite.org/schema/kernel-2.1", "nameIdentifier");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: au.edu.aekos.shared.doiclient.jaxb
     * 
     */
